...
saeb_exog03 = saeb_censo.loc[:,['IN_ESGOTO_FOSSA', 'IN_ESGOTO_INEXISTENTE', 'IN_LIXO_COLETA_PERIODICA', 'PC_FORMACAO_DOCENTE_INICIAL', 'IN_QUADRA_ESPORTES',
'IN_INTERNET', 'IN_SALA_PROFESSOR', 'IN_AGUA_REDE_PUBLICA', 'IN_AGUA_INEXISTENTE', 'IN_BIBLIOTECA_SALA_LEITURA', 'IN_PARQUE_INFANTIL', 'IN_LABORATORIO_INFORMATICA',
'IN_EQUIP_SOM', 'IN_EQUIP_FAX', 'IN_EQUIP_RETROPROJETOR', 'IN_EQUIP_FOTO', 'IN_SECRETARIA', 'IN_ALMOXARIFADO', 'TP_AEE', 'IN_SALA_ATENDIMENTO_ESPECIAL',
'IN_FUNDAMENTAL_CICLOS', 'IN_EQUIP_IMPRESSORA', 'IN_LAVANDERIA', 'IN_EQUIP_IMPRESSORA_MULT', 'IN_EQUIP_TV', 'IN_ENERGIA_INEXISTENTE', 'IN_ALIMENTACAO']]
